...
export const investigations = mysqlTable("investigations", {
  ...
  recoveredObjects: text("recovered_objects").default("[]"),
  securedDrug: text("secured_drug").default("[]"),
  ...
  securedVehicles: text("secured_vehicles").default("[]"),
  securedObjects: text("secured_objects").default("[]"),
